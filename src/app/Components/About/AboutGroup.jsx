...
//                     <p className="text-gray-600 leading-relaxed">
//                       {
//                         "I realized that with the right guidance, anyone could transform their career trajectory and find true professional fulfillment."
//                       }
//                     </p>
//                     <div className="text-sm text-gray-500">- Dr. Sarah Mitchell, 2018</div>
//                   </div>
...
//                   <div className="relative text-center space-y-6 z-10">
//                     <div className="relative inline-block">
//                       {/* Full Profile Image - No Circle */}
//                       <div className="w-72 h-80 mx-auto overflow-hidden rounded-2xl shadow-2xl">
//                         <img
//                           src='https://cofd2uo2s6.ufs.sh/f/LSgXeBx6oTrNxXcBOcqmuzPqp9wjrgOT0K2db6e7lJXyCvkZ'
//                           alt="Dr. Sarah Mitchell - Founder & CEO"
//                           className="w-full h-full object-cover object-center"
//                         />
//                       </div>
//                       {/* Decorative ring around image */}
//                       <div
//                         className="absolute -inset-3 bg-gradient-to-r from-[#d62332]/20 to-[#b51d2a]/20 rounded-3xl -z-10"
//                         style={{
//                           clipPath: "polygon(0% 20%, 20% 0%, 80% 0%, 100% 20%, 100% 80%, 80% 100%, 20% 100%, 0% 80%)",
//                         }}
//                       ></div>
...
//                           <p className="text-gray-700 italic leading-relaxed">
//                             {
//                               "Every person has unique talents waiting to be discovered. My mission is to help individuals unlock their potential and find careers that truly fulfill them."
//                             }
//                           </p>
//                           <p className="text-xs text-gray-500 mt-2">- Dr. Sarah Mitchell</p>
//                         </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  It all started when our founder, <strong>Mr. Subhajit Guha</strong>, witnessed countless talented individuals
                  struggling to find their career direction despite having exceptional skills and qualifications.
                </p>
                <p>
                  After years of working in corporate HR and seeing the disconnect between individual potential and
                  career satisfaction, he realized that personalized, expert guidance could bridge this gap.
                </p>
                <p>
                  What began as a small consulting practice has evolved into a comprehensive platform that combines
                  human expertise with cutting-edge technology to deliver meaningful career transformation results.
              ...
              <Card className="border-0 shadow-2xl bg-gradient-to-br from-[#d62332]/5 to-[#b51d2a]/5 rounded-3xl overflow-hidden">
                <CardContent className="p-12">
                  <div className="text-center space-y-6">
                    ...
                    <div className="text-sm text-gray-500">- Mr. Subhajit Guha, 2018</div>
                  </div>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="relative p-8 lg:p-12 overflow-hidden">
                  ...
                  <div className="relative text-center space-y-6 z-10">
                    <div className="relative inline-block">
                      {/* Full Profile Image - No Circle */}
                      <div className="w-80 h-[28rem] mx-auto overflow-hidden rounded-2xl shadow-2xl">
                        <img
                          src='https://cofd2uo2s6.ufs.sh/f/LSgXeBx6oTrNKwRg9GHUsN3CWvbkSz68HF4VfEl2eTyAIr0a'
                          alt="Mr. Subhajit Guha - Pioneer & Owner"
                          className="w-full h-full object-cover object-center"
                        />
                      </div>
                      {/* Decorative ring around image */}
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">Mr. Subhajit Guha</h3>
                      <p className="text-lg text-[#d62332] font-semibold">Pioneer & Owner</p>
                      <p className="text-gray-600 mt-2">MBA in Marketing, Annamalai University</p>
                    </div>
                  </div>
                </div>
                {/* Right - Content Section */}
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-2">- Mr.Subhajit Guha</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
