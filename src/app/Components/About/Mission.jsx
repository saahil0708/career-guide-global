  ...
  const mainSections = [
    {
      ...
      gradient: "from-[#4fbe99] to-[#3da582]",
      testimonial: {
        name: "Sarah Chen",
    ...
    },
    {
      ...
      gradient: "from-[#3da582] to-[#2d8a6b]",
      testimonial: {
    ...
    },
    {
      ...
      gradient: "from-[#2d8a6b] to-[#4fbe99]",
      testimonial: {
        name: "Emily Johnson",
  ...
  const coreValues = [
    {
      ...
      color: "from-[#4fbe99]/20 to-[#3da582]/20",
    },
    {
      ...
      color: "from-[#3da582]/20 to-[#2d8a6b]/20",
    },
    {
      ...
      color: "from-[#2d8a6b]/20 to-[#4fbe99]/20",
    },
    {
  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-[#4fbe99]/8 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-[#3da582]/8 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[800px] bg-gradient-to-r from-[#4fbe99]/4 to-[#3da582]/4 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <div className="flex justify-center mb-8">
            <Badge className="bg-gradient-to-r from-[#4fbe99]/15 to-[#3da582]/15 text-[#4fbe99] border-[#4fbe99]/30 rounded-full px-8 py-2 text-lg font-semibold shadow-lg">
          ...
          <div className="flex justify-center items-center space-x-8 text-sm text-gray-500">
            <div className="flex items-center space-x-2">
              <Globe className="w-4 h-4 text-[#4fbe99]" />
              <span>Global Impact</span>
            </div>
            <div className="flex items-center space-x-2">
              <Award className="w-4 h-4 text-[#4fbe99]" />
              <span>Award Winning</span>
            </div>
            <div className="flex items-center space-x-2">
              <TrendingUp className="w-4 h-4 text-[#4fbe99]" />
              ...
              <TabsList className="grid grid-cols-3 bg-white/90 backdrop-blur-sm rounded-2xl p-1.5 shadow-xl border border-gray-100/50 w-full max-w-3xl h-16">
                {mainSections.map((section) => (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#4fbe99] to-[#3da582] opacity-0 data-[state=active]:opacity-100 transition-all duration-500 ease-in-out rounded-xl group-data-[state=active]:opacity-100"></div>

                    {/* Hover background */}
                    <div className="absolute inset-0 bg-gradient-to-r from-[#4fbe99]/10 to-[#3da582]/10 opacity-0 group-hover:opacity-100 transition-all duration-300 ease-in-out rounded-xl"></div>
                ...
                <Card className="border-0 shadow-2xl bg-white/90 backdrop-blur-xl rounded-3xl overflow-hidden mx-auto max-w-6xl">
                  ...
                  <CardContent className="p-8 lg:p-12">
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                          <h4 className="text-xl font-semibold text-gray-900 flex items-center justify-center lg:justify-start">
                            <CheckCircle className="w-5 h-5 text-[#4fbe99] mr-2" />
                            Key Focus Areas
                          </h4>
                          <div className="space-y-4">
                            {section.keyPoints.map((point, idx) => (
                              <div key={idx} className="flex items-start space-x-3 group">
                                <div className="w-2 h-2 bg-[#4fbe99] rounded-full mt-2 group-hover:scale-150 transition-transform duration-200 flex-shrink-0"></div>
                      ...
                      <div className="flex justify-center lg:justify-start">
                        <Card className="bg-gradient-to-br from-gray-50 to-white border-l-4 border-l-[#4fbe99] shadow-lg w-full max-w-md">
                          <CardContent className="p-6">
                            <div className="space-y-4">
                              <div className="flex justify-center lg:justify-start">
                                <Quote className="w-8 h-8 text-[#4fbe99]" />
                              </div>
        ...
        <div className="flex justify-center mb-16">
          <Separator className="w-32 bg-gradient-to-r from-transparent via-[#4fbe99]/30 to-transparent" />
        </div>
        ...
        <div className="space-y-12">
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <Badge className="bg-gradient-to-r from-[#4fbe99]/10 to-[#3da582]/10 text-[#4fbe99] border-[#4fbe99]/20 rounded-full px-6 py-2 text-base font-medium">
              ...
              >
                ...
                <CardContent className="relative p-8 h-full flex flex-col">
                  <div className="flex flex-col items-center text-center space-y-6 flex-1">
                    ...
                    >
                      <div className="text-[#4fbe99]">{value.icon}</div>
                    </div>

                    <div className="space-y-4 flex-1">
                      <h4 className="text-xl font-bold text-gray-900 group-hover:text-[#4fbe99] transition-colors duration-300">
                        {value.title}
                      </h4>
        ...
        {/* Call to Action */}
        <div className="mt-20">
          <Card className="bg-gradient-to-r from-[#4fbe99] to-[#3da582] border-0 shadow-2xl rounded-3xl overflow-hidden max-w-4xl mx-auto">
            <CardContent className="p-12 text-white text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  size="lg"
                  className="bg-white text-[#4fbe99] hover:bg-gray-100 rounded-xl px-8 py-4 text-lg font-semibold"
                >
